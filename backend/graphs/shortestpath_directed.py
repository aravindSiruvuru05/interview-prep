...
# (see graphs/README.md → Algorithm Intuitions for full explanation)
#
# Scenario                                  | Algorithm              | Time
# DAG (Directed Acyclic Graph)              | Topological Sort + relax | O(V + E)  — efficient for DAGs
# General graph, non-negative weights       | Dijkstra's Algorithm   | O(E log V) — works for directed/undirected;
#                                           |                        | on DAGs, topo+relax beats Dijkstra (no heap rebalancing per relax)
# General graph, negative weights           | Bellman-Ford           | O(VE)
